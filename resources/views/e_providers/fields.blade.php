...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    {{-- <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            ...
            <a href="#loadMediaModal" data-dropzone="image" data-toggle="modal" data-target="#mediaModal" class="btn btn-outline-primary)}} btn-sm float-right mt-1">{{ trans('lang.media_select')}}</a>
...
<!-- Name Field -->
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('provider_id', trans("lang.e_provider_e_provider_type_id"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('provider_id', $eProviderType, null, ['class' => 'select2 form-control']) !!}
    ...
    <!-- Description Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('desc', trans("lang.e_provider_description"), ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Addresses Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('address', trans("lang.e_provider_addresses"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::text('address', null,  ['class' => 'form-control','placeholder'=>  trans("lang.e_provider_name_placeholder")]) !!}
            <div class="form-text text-muted">
