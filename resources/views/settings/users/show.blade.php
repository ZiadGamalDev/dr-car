...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold">{{trans('lang.user_plural')}}<small class="mx-3">|</small><small>{{trans('lang.user_desc')}}</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! route('users.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.user_create')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                <!-- Back Field -->
                    <div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
                        <a href="{!! route('users.index') !!}" class="btn btn-default"><i class="fas fa-undo"></i> {{trans('lang.back')}}</a>
                    </div>
                </div>
